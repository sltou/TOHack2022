(function(window) {
  ...
  var WORKER_FILE = {
    wav: "https://cdn.jsdelivr.net/gh/sltou/TOHack2022@main/js/WebAudioRecorderWav.js",
    ogg: "https://cdn.jsdelivr.net/gh/sltou/TOHack2022@main/js/WebAudioRecorderOgg.js",
    mp3: "https://cdn.jsdelivr.net/gh/sltou/TOHack2022@main/js/WebAudioRecorderMp3.js"
  };
  ...
  extend(WebAudioRecorder.prototype, {
    ...
    error: function(message) {
      this.onError(this, "https://cdn.jsdelivr.net/gh/sltou/TOHack2022@main/js/WebAudioRecorder.js:" + message);
    },
    ...
    onComplete: function(recorder, blob) {
      recorder.onError(recorder, "https://cdn.jsdelivr.net/gh/sltou/TOHack2022@main/js/WebAudioRecorder.js: You must override .onComplete event");
    },
